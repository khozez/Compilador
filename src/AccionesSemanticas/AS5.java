    ...
    public int ejecutar(BufferedInputStream lector, String lexema) {
        try {
            ...
            if (num > AnalizadorLexico.MAX_ULONG_INT){
                ...
                num = 0;
                Parser.anotar(Parser.ERROR_LEXICO, "LINEA "+AnalizadorLexico.getCantLineas()+": WARNING! Constante "+AnalizadorLexico.lexema+" fue truncado ya que es inferior al valor minimo");
            }
